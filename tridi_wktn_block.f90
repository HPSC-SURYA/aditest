...
program tridi_wktn_block
	...
	allocate(c(n,n))
	allocate(d(n,n))
	allocate(x(indexspan,n))
	allocate(bp(n,n))
	allocate(acorr(indexspan,n))
	allocate(acorr2(indexspan,n))
	...
	if (numproc .eq. 1) then
		...
		call tridi_block(a,b,c,d,x,n,myid,numproc,bp,acorr,acorr2,indexspan,startindex)
	endif
...
subroutine tridi_block(a,b,c,d,x,n,myid,numproc,bp,acorr,acorr2,indexspan,startindex)
	implicit none
	include "mpif.h"
